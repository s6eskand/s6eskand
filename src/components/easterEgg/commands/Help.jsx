...
function Help() {
    return(
        <p>
            ...
            <span style={{color: "yellow"}}>ls</span> display contents of current directory <br/><br/> {/* TODO: Status, not started */}
            <span style={{color: "yellow"}}>code</span> edit your solution<br/><br/> {/* TODO: Status, in progress */}
            <span style={{color: "yellow"}}>cat &lt;file_name&gt;</span> print contents of txt file <br/><br/>
            <span style={{color: "yellow"}}>verify &lt;file_name&gt;</span> verify your answer to move forward <br/><br/> {/* TODO: Status, not started */}
